...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$_SESSION['msg'] = $sql ? "Category updated successfully" : "Category could not be updated";
						...
						<div class="content">
							<div class="module">
								<div class="module-head justify-div">
									<h3>Category</h3>
									<a class="btn btn-primary" href="category.php"><i class="icon-chevron-left"></i> Back </a>
								</div>
