...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$query = "INSERT INTO `state`(`stateName`, `stateDescription`, `postingDate`, `updationDate`) VALUES ('$state','$description', NOW(), '$date')";
		$sq = "insert into state(stateName,stateDescription,postingDate,updationDate) values('$state','$description', NOW(), '$date') ";
		$sql = mysqli_query($bd, $sq);
		if ($sql) {
			$_SESSION['msg'] = "State added Successfully !!";
			$_SESSION['success'] = true ;
		} else {
			$_SESSION['msg'] = "State not added !!";
											...
											?>
												<tr>
													...
													<td>
														...
														<a href="state.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a>
													</td>
												</tr>
											<?php $cnt = $cnt + 1;
											} ?>
