...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$query2 = "INSERT INTO `faculty`(`facultyName`, `email`, `contact`, `facultyDescription`, `creationDate`, `updationDate`) VALUES ('$faculty', '$email', '$contact', '$description', NOW(), '$date')";
		$sql = mysqli_query($bd, $query2);
		if ($sql) {
			$_SESSION['msg'] = "Faculty Created successfully";
			$_SESSION['success'] = true;
		} else {
			$_SESSION['msg'] = "Faculty not created";
			$_SESSION['success'] = false;
		}
	}

	if (isset($_GET['del'])) {
		mysqli_query($bd, "delete from faculty where id = '" . $_GET['id'] . "'");
		$_SESSION['delmsg'] = "Faculty deleted !!";
	}
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="Faculty" method="post">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" placeholder="Enter Faculty Name" name="faculty" class="span8 tip" required>
											</div>
										</div>
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												<input type="email" placeholder="Enter Faculty Email" name="email" class="span8 tip" required>
											</div>
										</div>
                                        ...
                                        <div class="control-group">
											...
											<div class="controls">
												<input type="number" placeholder="Enter Faculty phone number" name="contact" class="span8 tip" required>
											</div>
										</div>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a href="edit-faculty.php?id=<?php echo $row['id'] ?>"><i class="icon-edit"></i></a>
														<a href="faculty.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a>
													</td>
												</tr>
											<?php $cnt = $cnt + 1;
											} ?>
