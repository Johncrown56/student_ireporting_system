...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$_SESSION['msg'] = $sql ? "SubCategory updated successfully" : "SubCategory could not be updated";
						...
						<div class="content">
							<div class="module">
								<div class="module-head justify-div">
									...
									<a class="btn btn-primary" href="subcategory.php"><i class="icon-chevron-left"></i> Back </a>
								</div>
