...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$_SESSION['msg'] = $sql ? "State info updated successfully" : "State info could not be updated";
								...
								<form class="form-horizontal row-fluid" name="Category" method="post">
									...
									?>
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea class="span8" name="description" rows="5"><?php echo  htmlentities($row['stateDescription']); ?></textarea>
											</div>
										</div>
									<?php } ?>
