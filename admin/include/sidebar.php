<div class="span3">
	<div class="sidebar">
			...
			<li>
				...
				<ul id="togglePages" class="collapse unstyled">
					<li><a href="notprocess-complaint.php">
							<i class="icon-tasks"></i> Not Process Yet Complaint
							<?php
					...
					<li> <a href="inprocess-complaint.php">
							<i class="icon-tasks"></i> Pending Complaint
							<?php
							$status = "in Process";
		...
		<ul class="widget widget-menu unstyled">
			<li><a href="faculty.php"><i class="menu-icon icon-tasks"></i> Add Faculty </a></li>
