...
CREATE TABLE `users` (
  ...
  `matricNo` bigint(11) DEFAULT NULL,
  `address` tinytext,
...
INSERT INTO `users` (`id`, `fullName`, `userEmail`, `password`, `matricNo`, `address`, `State`, `country`, `pincode`, `userImage`, `regDate`, `updationDate`, `status`) VALUES
