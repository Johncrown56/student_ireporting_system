...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($bd, "update users set fullName='$fname',matricNo='$matricno',address='$address',State='$state',country='$country',pincode='$pincode' where matricNo='" . $_SESSION['login'] . "'");
    if ($query) {
...
?>
  ...
  <head>
    ...
    <title>iReporting System | User Change Password</title>
              ...
              <div class="form-panel">
                ...
                <?php if ($errormsg) { ?>
                  <div class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <b>Error</b> </b> <?php echo htmlentities($errormsg); ?>
                  </div>
                <?php } ?>
                <?php $query = mysqli_query($bd, "select * from users where matricNo='" . $_SESSION['login'] . "'");
                ...
                ?>
                  ...
                  <form class="form-horizontal style-form" method="post" name="profile">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" name="matricno" required="required" value="<?php echo htmlentities($row['matricNo']); ?>" class="form-control">
                      </div>
