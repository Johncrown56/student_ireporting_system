...
if (isset($_POST['submit'])) {
	...
	$status = 1;
	$query = mysqli_query($bd, "insert into users(fullName,userEmail,password,matricNo,status) values('$fullname','$email','$password','$matricno','$status')");
...
<head>
	...
	<title>iReporting System | User Registration</title>
		...
		<div class="container">
			...
			<form class="form-login" method="post">
				...
				<div class="login-wrap">
					...
					<input type="number" class="form-control" maxlength="9" name="matricno" placeholder="Matric no" required="required" autofocus>
					<br>
