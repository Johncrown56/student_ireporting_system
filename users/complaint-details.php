...
<html lang="en">
  <head>
    ...
    <title>iReporting System | Complaint Details</title>
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
            <div style="display: flex; justify-content: space-between; margin-top: 20px; margin-bottom: 10px;">
          	<span class="h3" style="margin-top: 0px; margin-bottom: 0px;"><i class="fa fa-angle-right"></i> Complaint Details</span>
            <a class="btn btn-primary" href="complaint-history.php"><i class="fa fa-angle-left"></i> Back</a>
            </div>
            <hr />
...
<label class="col-sm-2 col-sm-2 control-label"><b>Submission Date :</b></label>
              <div class="col-sm-4">
