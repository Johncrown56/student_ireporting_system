...
?>
  ...
  <head>
    ...
    <title>iReporting System | Complaint History</title>
    ...
    <section id="container">
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i>Your Report History</h3>
          <div class="row mt">
            <div class="col-lg-12">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td align="center"><?php echo htmlentities($row['noc']); ?></td>
                          ...
                          <td align="center"><?php
                            ...
                            <?php } ?>
                          <td align="center">
                            <a class="btn btn-primary" href="complaint-details.php?cid=<?php echo htmlentities($row['complaintNumber']); ?>">View Details</a>
                          </td>
                        </tr>
                      <?php } ?>
